...
<div class="container py-8 px-6">
    <div class="mb-3 bg-inherit rounded-lg shadow p-4 flex justify-between items-center">
        ...
        <a href="{{ route('admin.service_providers.index') }}"
            class="btn btn-danger text-white bg-gray-700 hover:bg-gray-800 float-end rounded px-4 py-2">
            <i class="bi bi-arrow-left"></i> Back
        </a>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.service_providers.store') }}" method="POST"
            class="bg-white p-8 rounded-lg shadow-md grid grid-cols-1 md:grid-cols-2 gap-8">
            @csrf
            ...
            <div>
                <label class="block text-xl font-medium text-gray-700 mb-1">Specialization</label>
            ...
            <div class="md:col-span-2">
                <label class="block text-xl font-medium text-gray-700 mb-1">Bio</label>
                <textarea name="bio"
                    class="form-control mt-1 block w-full border border-gray-300 rounded-md shadow-sm
                    focus:border-blue-500 focus:ring-blue-500 px-4 py-2"
