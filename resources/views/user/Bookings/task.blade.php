...
@section('content')
    <div class="max-w-2xl mx-auto mt-10 bg-white rounded-xl shadow-lg p-10">
        ...
        <h2 class="text-xl  font-bold mt-8 text-gray-700 border-b border-gray-200 pb-2">Property Information</h2>
        ...
        <h2 class="text-xl font-bold mt-8 text-gray-700 border-b border-gray-200 pb-2">Package Information</h2>
        <p class="mt-2 text-gray-700"><span class="font-semibold">Package Name:</span>
            {{ $booking->package->name ?? 'N/A' }}</p>
        <p class="text-gray-700"><span class="font-semibold">Price:</span> {{ $booking->package->price ?? 'N/A' }}</p>

        <h2 class="text-xl font-bold mt-8 text-gray-700 border-b border-gray-200 pb-2">Tasks</h2>
