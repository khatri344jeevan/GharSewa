<section class="scroll-mt-24 bg-gray-100 py-12 px-6">
    <div class="max-w-7xl mx-auto">
        ...
        <p class="text-center text-lg text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed">
            GharSewa offers essential home maintenance services including cleaning, plumbing, and electrical repairs all
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div
                ...
                <div class="w-full">
                    ...
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                        ...
                        Customizable schedules and real-time updates included. Experience the convenience of a clean,
            ...
            <div
                ...
                <div class="w-full">
                    ...
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                        From routine installations to emergency repairs, we ensure your property stays powered, safe,
            ...
            <div
                ...
                <div class="w-full">
                    ...
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                        Leaky taps or major repairs — our skilled plumbers deliver reliable service on time. Available
            ...
            <div
                class="bg-white rounded-3xl shadow-lg p-10 flex flex-col gap-10 transition-transform hover:scale-[1.03] duration-300">
                <div class="w-full">
                    <h3 class="text-3xl font-extrabold text-gray-700 mb-6 tracking-wide">Device &amp; Appliance Support
                    </h3>
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed">
                        We provide setup, repair, and maintenance for essential devices like printers, tube lights,
                        scanners, projectors, and more. Our skilled technicians ensure your equipment stays efficient
