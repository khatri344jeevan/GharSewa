    ...
    <div class="max-w-7xl  flex flex-col md:flex-row items-center gap-20">
        ...
        <div class="md:w-1/2 text-left relative z-10">
            ...
            <p
                ...
                plumber, electrician, cleaner, or appliance repair expert . we bring verified service providers right to
                your doorstep. Book easily, get fast support, and enjoy peace of mind with our reliable team.
            </p>
