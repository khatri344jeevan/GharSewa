    ...
    <section class="max-w-7xl mx-auto px-6 py-16">
        <div class="text-center mb-14">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                Choose a monthly, 6-month, or yearly plan and ensure your plumbing stays in top shape with professional care.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div class="bg-white rounded-3xl border border-gray-200 shadow-md hover:shadow-xl transform hover:-translate-y-1 transition duration-300 p-8 flex flex-col">
                <img src="{{ asset('images/plumbing1.jpeg') }}" alt="1 Month Plumbing" class="w-full h-40 object-cover rounded-xl mb-4" loading="lazy">
                ...
                <p class="text-xs text-gray-500">SMS confirmation after service</p>
            </div>
            ...
            <div class="bg-white rounded-3xl border-2 border-yellow-400 shadow-xl relative transform hover:-translate-y-1 transition duration-300 p-8 flex flex-col">
                ...
                <img src="{{ asset('images/plumbing2.jpeg') }}" alt="6-Month Plumbing" class="w-full h-40 object-cover rounded-xl mb-4" loading="lazy">
                ...
                <p class="text-xs text-gray-500">Photo upload in dashboard</p>
            </div>
            ...
            <div class="bg-white rounded-3xl border border-gray-300 shadow-md hover:shadow-xl transform hover:-translate-y-1 transition duration-300 p-8 flex flex-col">
                <img src="{{ asset('images/plumbing3.jpeg') }}" alt="12 Month Plumbing" class="w-full h-40 object-cover rounded-xl mb-4" loading="lazy">
                ...
                <p class="text-xs text-gray-500">Detailed report with technician rating</p>
            </div>
        </div>
