...
<body>
    ...
    <div class="md:w-1/2 text-left relative z-10">
      <h2 class="text-5xl font-extrabold text-gray-700 mb-6 tracking-tight leading-tight border-l-8 border-gray-700 pl-5">
        About Us
      </h2>
      ...
      <ul class="space-y-5">
        <li class="flex items-start bg-gray-100 p-4 rounded-lg shadow hover:shadow-lg transition">
          ...
          <p class="text-gray-800 font-medium">Trained & Verified Professionals – Background-checked and skilled.</p>
        </li>
        <li class="flex items-start bg-gray-100 p-4 rounded-lg shadow hover:shadow-lg transition">
          <span class="text-gray-700 text-2xl mr-4 mt-1">✔️</span>
        ...
        <li class="flex items-start bg-gray-100 p-4 rounded-lg shadow hover:shadow-lg transition">
          <span class="text-gray-700 text-2xl mr-4 mt-1">✔️</span>
          <p class="text-gray-800 font-medium">Transparent Pricing – No hidden charges, upfront estimates.</p>
        </li>
        <li class="flex items-start bg-gray-100 p-4 rounded-lg shadow hover:shadow-lg transition">
          <span class="text-gray-700 text-2xl mr-4 mt-1">✔️</span>
    ...
    <div class="md:w-1/2 flex justify-center relative z-10">
      <div class="relative group w-full max-w-md transform transition duration-300 hover:scale-105">
        <div class="absolute -inset-2 bg-gray-200 rounded-3xl blur-xl opacity-50 group-hover:opacity-70 transition"></div>
        <img src="{{ asset('images/Aboutus.jpg') }}" alt="About Ghar Sewa" class="relative z-10 rounded-3xl shadow-2xl border-4 border-white w-full object-cover" />
      </div>
    </div>
  </div>
