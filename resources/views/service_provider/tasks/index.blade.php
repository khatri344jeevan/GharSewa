    ...
    <div class="ml-48">
        <div class="flex items-center justify-between space-x-4 ">
            ...
            <a href="{{ route('service_provider.tasks.create') }}"
                class="bg-gray-500 hover:bg-gray-600 text-white font-semibold px-6 py-3 rounded shadow-md mt-20 ml-10">
                <i class="bi bi-plus mr-2 text-xl"></i>Add Task
            </a>
        </div>

        <div class="mt-6 bg-white shadow-lg rounded-lg overflow-hidden ml-8">
            <table class="min-w-full divide-y divide-gray-200 text-sm text-gray-700">
                <thead class="bg-gray-300 text-gray-700 uppercase text-xs ">
                    <tr>
                        ...
                        <th class="px-6 py-3  text-center">Owner Name</th>
