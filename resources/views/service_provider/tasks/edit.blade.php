    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <form action="{{ route('service_provider.tasks.update', $task->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="remarks" id="remarks" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500" placeholder="Enter any remarks or notes">{{ $task->remarks }}</textarea>
            </div>
